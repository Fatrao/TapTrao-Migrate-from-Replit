export const AVATAR_COLOURS: Record<string, { bg: string; border: string; text: string }> = {
  CI: { bg:'rgba(74,140,111,.18)',  border:'rgba(74,140,111,.32)',  text:'#7fb59a' },
  ...
  ET: { bg:'rgba(74,140,111,.12)',  border:'rgba(74,140,111,.22)',  text:'#7fb59a' },
  ...
  ZA: { bg:'rgba(74,140,111,.15)', border:'rgba(74,140,111,.28)', text:'#7fb59a' },
