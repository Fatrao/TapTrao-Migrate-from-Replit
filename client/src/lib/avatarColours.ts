export const AVATAR_COLOURS: Record<string, { bg: string; border: string; text: string }> = {
  CI: { bg:'rgba(14,78,69,.18)',  border:'rgba(14,78,69,.32)',  text:'#7fb59a' },
  ...
  ET: { bg:'rgba(14,78,69,.12)',  border:'rgba(14,78,69,.22)',  text:'#7fb59a' },
  ...
  ZA: { bg:'rgba(14,78,69,.15)', border:'rgba(14,78,69,.28)', text:'#7fb59a' },
